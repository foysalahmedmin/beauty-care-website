...
const Aesthetic = () => {
    ...
    const { data, isLoading } = useQuery({
        queryKey: ["one_aesthetic_clinic", slug],
            ...
            {isLoading ? (
                ...
                <>
                    ...
                    <div className="container w-full md:order-2 mt-6">
                        ...
                        <ReactCompareImage
                            leftImage={`${urls?.before}/${data?.compare?.before}`}
                            rightImage={`${urls?.after}/${data?.compare?.after}`}
                        />
                    </div>
                    <div className="container mx-auto px-4 py-12">
                        <div className="mb-12">
                            <h2 className="text-3xl font-bold text-gray-800 mb-6">{data?.name}</h2>
                        ...
                        <div className="mb-12">
                            ...
                            <div className="bg-white rounded-lg shadow-md p-6">
                                <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {data?.after_instructions?.map((instruction, index) => (
                                        <li key={index} className="flex items-start gap-3">
