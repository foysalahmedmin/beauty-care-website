    ...
    return (
        <main className="min-h-screen">
            ...
            <div className="container mx-auto px-4 py-12">
                {/* Overview */}
                <div className="mb-12">
                    <h2 className="text-3xl font-bold text-gray-800 mb-6">{aesthetic?.category}</h2>
                    <p className="text-lg text-gray-600 mb-8">{aesthetic?.overview}</p>
                </div>
                ...
                <div className="mb-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {aesthetic?.treatments.map((treatment, index) => (
                ...
                <div className="mb-12 bg-gray-50 p-8 rounded-lg">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {aesthetic?.benefits?.map((benefit, index) => (
                ...
                <div className="mb-12">
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6">
                        <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {aesthetic?.aftercare?.map((instruction, index) => (
