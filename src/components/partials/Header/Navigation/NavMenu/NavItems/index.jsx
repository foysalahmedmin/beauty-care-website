...
const NavItem = ({ item, isOpen, setIsOpen }) => {
  ...
  return (
    <li className="group flex font-light">
      ...
      {children && children?.length > 0 && (
        <div className="light invisible absolute -bottom-6 left-0 w-80 translate-y-full bg-card p-4 text-title opacity-0 shadow-xl transition-all duration-300 group-hover:visible group-hover:opacity-100 lg:w-[32rem]">
